...
const translations = {
  fr: {
    ...
    assistantWelcome: 'Comment puis-je vous aider pour votre voyage ?',
    assistantPlaceholder: 'Écrivez votre question...',
    assistantError: "L'assistant est momentanément indisponible.",
    esim: 'eSIM',
    driver: 'Chauffeur',
    hotels: 'Hôtels',
  ...
  en: {
    ...
    assistantWelcome: 'How can I help with your trip?',
    assistantPlaceholder: 'Write your question...',
  ...
  ar: {
    ...
    assistantWelcome: 'كيف يمكنني مساعدتك في رحلتك؟',
    assistantPlaceholder: 'اكتب سؤالك...',
    assistantError: 'المساعد غير متاح مؤقتًا.',
    esim: 'شريحة eSIM',
    driver: 'سائق',
    hotels: 'فنادق',
    marketplace: 'السوق',
